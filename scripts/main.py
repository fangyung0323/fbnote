...
# ==================== 預設角色（依類別） ====================
DEFAULT_ROLES = {
    "植物": "你是一位觀察植物與空間關係的紀錄者。",
    "永續": "你是一位觀察日常環境變化的紀錄者。",
    "碳盤查": "你是一位觀察生活中資源流動的紀錄者。",
    "生活": "你是一位記錄生活場景的人。"
}
...
<body>
    ...
    APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyb5SP8GCGdMDMniLfGcqHuvzrGw9XNp3JSS6l2dWLvb55ELVmJe0OlpmzVShJ3j7Pw/exec'
